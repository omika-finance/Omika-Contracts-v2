...
const providers = {
  ...
  chiadoTestnet: new ethers.providers.JsonRpcProvider(CHIADO_TESTNET_URL),
}
...
const signers = {
  ...
  chiadoTestnet: new ethers.Wallet(CHIADO_TESTNET_DEPLOY_KEY).connect(providers.chiadoTestnet),
}
